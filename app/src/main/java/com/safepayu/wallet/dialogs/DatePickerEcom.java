...
public class DatePickerEcom extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    private EditText editText;
    private TextView textView;

    public static DatePickerEcom newInstance(EditText editText, TextView textView) {
        DatePickerEcom fragment = new DatePickerEcom();
