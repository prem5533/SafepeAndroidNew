...
public class DatePickerHidePreviousDate extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    private EditText editText;
    private TextView textView;

    public static DatePickerHidePreviousDate newInstance(EditText editText, TextView textView) {
        DatePickerHidePreviousDate fragment = new DatePickerHidePreviousDate();
