                    ...
                    public void onSuccess(ResponseModel response) {
                        ...
                        if (response.status) {
                            try {
                                ...
                                mInstruction = new InstructionAdapter(AvailableBalanceFDActivity.this, response.data.instruction);
                                rv_instruction.setAdapter(mInstruction);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        } else {
                            BaseApp.getInstance().toastHelper().showSnackBar(AvailableBalanceFDActivity.this.findViewById(R.id.ll_parant), response.message, false);
                        }
                    }
