...
public class FlightListActivity extends AppCompatActivity implements View.OnClickListener, OneWayFlightListAdapter.OnFlightItemListener {
    ...
    private String Source,Destination,JourneyDate,TripType,User,UserType,Adults,Infants,Children;
    private String FlightType,ReturnDate,TravelClass,TrvaellersCount,ClassType;
