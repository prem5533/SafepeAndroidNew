...
public class InvestmentDepositActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(InvestmentDepositActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_fixed_deposit:
                startActivity(new Intent(InvestmentDepositActivity.this, AvailableBalanceActivity.class).
            ...
            case R.id.ll_paytm_wallet:
                startActivity(new Intent(InvestmentDepositActivity.this, WalletActivity.class));
                overridePendingTransition(R.anim.left_to_right, R.anim.slide_out);
                break;

            case R.id.ll_total_amount:
                startActivity(new Intent(InvestmentDepositActivity.this, InvestmentDepositListActivity.class).
                        putExtra("depositAmount", depositAmount).
                        putExtra("fdInterest", fdInterest).putExtra("balanceAmount", balanceAmount));
                overridePendingTransition(R.anim.left_to_right, R.anim.slide_out);
                break;
            case R.id.ll_investment_wallet:
                startActivity(new Intent(InvestmentDepositActivity.this, InvestmentWallet.class));
                overridePendingTransition(R.anim.left_to_right, R.anim.slide_out);
                break;
    ...
    private void safepeInvestmentAccount() {
        ...
        ApiService apiService = ApiClient.getClient(InvestmentDepositActivity.this).create(ApiService.class);
                ...
                .subscribeWith(new DisposableSingleObserver<ResponseModel>() {
                    ...
                    public void onSuccess(ResponseModel response) {
                        ...
                        if (response.status) {
                            ...
                            BaseApp.getInstance().toastHelper().showSnackBar(InvestmentDepositActivity.this.findViewById(R.id.ll_parant), response.message, false);
                        }
                    }
