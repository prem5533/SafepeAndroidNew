...
public class CreateInvestmentDepositActivity extends AppCompatActivity implements View.OnClickListener, TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(CreateInvestmentDepositActivity.this);
                    ...
                    public void onSuccess(InvestmentReferResponse response) {
                        ...
                        try {
                            if (response.isStatus()) {
                                ...
                                Toast.makeText(CreateInvestmentDepositActivity.this, response.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    if (amt == 0) {
                        ...
                        if (amt > 0) {
                            if (amt > 999 && amt < 500000 + 1) {
                                if (referralCheck) {
                                    Intent intent = new Intent(CreateInvestmentDepositActivity.this, InvestmentChoosePayment.class);
