...
public class FixedDepositDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._fddetail);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_contct_support:
                startActivity(new Intent(FixedDepositDetailActivity.this, ContactUs.class));
                finish();
                break;
...
//                    }
    ...
    private void getFixedDepositPdf() {
        ...
        ApiService apiService = ApiClient.getClient(FixedDepositDetailActivity.this).create(ApiService.class);
                ...
                .subscribeWith(new DisposableSingleObserver<FlighPdfResponse>() {
                    ...
                    public void onSuccess(FlighPdfResponse response) {
                        ...
                        if (response.isStatus()) {
                            ...
                            new DownloadTask(FixedDepositDetailActivity.this, response.getData());
                        }
