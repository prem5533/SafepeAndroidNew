...
public class InvestmentChoosePayment extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener,BuyMembershipAdapter.OnBankItemListener{
                ...
                if (TextUtils.isEmpty(Amount) || Amount.equalsIgnoreCase("0")){
                    ...
                    if (TransactionType.equalsIgnoreCase("1")){
                        ...
                        if (BaseApp.getInstance().sharedPref().getString(BaseApp.getInstance().sharedPref().PAYMENT_SCREEN).equals("0")) {
                            intent = new Intent(InvestmentChoosePayment.this, PaymentTypeNew.class);
                        }else {
                            intent = new Intent(InvestmentChoosePayment.this, PaymentType.class);
                        }
                        ...
                        if (TextUtils.isEmpty(BankName)){
                            ...
                            Intent intent=new Intent(InvestmentChoosePayment.this, MemberBankAddPackages.class);
                    ...
                    public void onSuccess(PackageListData response) {
                        ...
                        if (response.getStatus()) {
                            ...
                            try {
                                ...
                                buyMembershipAdapter = new BuyMembershipAdapter(getApplicationContext(),response.getBankDetails(), InvestmentChoosePayment.this);
