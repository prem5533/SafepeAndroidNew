...
public class ItemView extends FrameLayout {
    ...
    private void generateViews(TypedArray styles) {
        ...
        int textColor = styles.getColor(R.styleable.PassCodeTextView_android_textColor
                , ResourcesCompat.getColor(context.getResources(), android.R.color.black, null));
        float barHeight = styles.getDimension(R.styleable.PassCodeTextView_bar_height, defaultHeight);
        float barMargin = styles.getDimension(R.styleable.PassCodeTextView_bar_margin, Utils.getPixels(context, 0));
        float barMarginBottom = styles.getDimension(R.styleable.PassCodeTextView_bar_margin_bottom, DEFAULT_BAR_MARGIN);
        float barMarginRight = styles.getDimension(R.styleable.PassCodeTextView_bar_margin_right, DEFAULT_BAR_MARGIN);
        float barMarginLeft = styles.getDimension(R.styleable.PassCodeTextView_bar_margin_left, DEFAULT_BAR_MARGIN);
        float barMarginTop = styles.getDimension(R.styleable.PassCodeTextView_bar_margin_top, DEFAULT_BAR_MARGIN);
        hideOTP = styles.getBoolean(R.styleable.PassCodeTextView_hide_otp, false);
        hideOTPDrawable = styles.getResourceId(R.styleable.PassCodeTextView_hide_otp_drawable
                , R.drawable.bg_pin);

        defaultOTPDrawable = ResourcesCompat.getColor(context.getResources(), R.color.transparent, null);

        boolean barEnabled = styles.getBoolean(R.styleable.PassCodeTextView_bar_enabled, false);

        Float otpTextSize = styles.getDimension(R.styleable.PassCodeTextView_otp_text_size, defaultOtpTextSize);

        String otpTextTypeFace = styles.getString(R.styleable.PassCodeTextView_text_typeface);
        int boxBackgroundColor = styles.getResourceId(R.styleable.PassCodeTextView_otp_box_background
                , ResourcesCompat.getColor(context.getResources(), R.color.transparent, null));
        boxBackgroundColorActive = styles.getResourceId(R.styleable.PassCodeTextView_otp_box_background_active
                , boxBackgroundColor);
        boxBackgroundColorInactive = styles.getResourceId(R.styleable.PassCodeTextView_otp_box_background_inactive
                , boxBackgroundColor);
        boxBackgroundColorSuccess = styles.getResourceId(R.styleable.PassCodeTextView_otp_box_background_success
                , boxBackgroundColor);
        boxBackgroundColorError = styles.getResourceId(R.styleable.PassCodeTextView_otp_box_background_error
                , boxBackgroundColor);
        barActiveColor = styles.getColor(R.styleable.PassCodeTextView_bar_active_color
                , ResourcesCompat.getColor(context.getResources(), android.R.color.black, null));
        barInactiveColor = styles.getColor(R.styleable.PassCodeTextView_bar_inactive_color
                , ResourcesCompat.getColor(context.getResources(), R.color.grey_400, null));
        barErrorColor = styles.getColor(R.styleable.PassCodeTextView_bar_error_color
                , ResourcesCompat.getColor(context.getResources(), R.color.red_400, null));
        barSuccessColor = styles.getColor(R.styleable.PassCodeTextView_bar_success_color
                , ResourcesCompat.getColor(context.getResources(), android.R.color.black, null));
