...
import com.safepayu.wallet.activity.booking.flight.BookingPaymentActivity;
...
public class EcomPaymentActivity extends AppCompatActivity {

    String paidAmount,totalCartItem,totalTax,totalDeliveryCharge,totalDiscount;
    private TextView tvEcomPayAmount,tvWalletLimit,tvTotalBalanceWallet,tvWalletDeductAmount, tvGatewayDeductAmount;;
    ...
    private Button btnOrderPayAmount;
   ...
   /*     SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
        ...
        btnOrderPayAmount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  customerOrderSave();
                ...
                hashKeyRequest.setMerchant_payment_amount(String.valueOf(paidAmount));
        ...
        checkBoxWallet.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    ...
                    tvGatewayDeductAmount.setVisibility(View.VISIBLE);
                    checkBoxGatewayPayment.setChecked(true);
                    tvGatewayDeductAmount.setText(paidAmount);
                }
            }
        });
    }
    ...
    private void DoPayment(HashKeyRequest hashKeyRequest, HashKeyResponse hashKeyResponse) {
        ...
        merchant_udf4="udf4";
        merchant_udf5="udf5";
        merchant_payment_amount = Float.parseFloat(String.valueOf(paidAmount));
...
//            sendPaymentGatewayDetailsRequest.setPackage_id("");
    ...
    private void customerOrderSave() {
     ...
     //   orderSaveRequest.setOrder_status();
        ...
        orderSaveRequest1.setAmt_without_tax_discount((Double.parseDouble(paidAmount)- Double.parseDouble(totalTax)));
       ...
       // orderSaveRequest.setLoyelty_used_amount();
        ...
        orderSaveRequest1.setDelivery_type("Click & Collect");
        orderSaveRequest1.setDelivery_time("9:00am - 12:am");
