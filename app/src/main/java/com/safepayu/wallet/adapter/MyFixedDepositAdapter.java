...
public class MyFixedDepositAdapter extends RecyclerView.Adapter<MyFixedDepositAdapter.MyOrderViewHolder> {

    private Context context;
    private List<InvestmentResponse.DataBean.InvestmentBean> investmentBeanList;
    private MyFixedDepositAdapter.OnFDSelectListener callback;

    public MyFixedDepositAdapter(Context context, List<InvestmentResponse.DataBean.InvestmentBean> investmentBeanList, OnFDSelectListener callback) {
    ...
    public MyOrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fixed_deposit_adapter, parent, false);

        return new MyFixedDepositAdapter.MyOrderViewHolder(itemView);
    }
