...
public class FlightReturnDetailAdapter extends RecyclerView.Adapter<FlightReturnDetailAdapter.FlightDetailViewHolder> {

    private Context context;
    private List< AvailableFlightResponse.DataBean.DomesticReturnFlightsBean.FlightSegmentsBeanX>mdata;


    public FlightReturnDetailAdapter(Context context, List<AvailableFlightResponse.DataBean.DomesticReturnFlightsBean.FlightSegmentsBeanX> mdata) {
    ...
    public FlightDetailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FlightReturnDetailAdapter.FlightDetailViewHolder(view);
    }
