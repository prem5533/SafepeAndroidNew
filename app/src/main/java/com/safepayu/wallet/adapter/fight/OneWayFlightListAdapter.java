...
public class OneWayFlightListAdapter extends RecyclerView.Adapter<OneWayFlightListAdapter.OneWayListViewHolder> {
    ...
    public class  OneWayListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindData(int position) {
            ...
            tvFlightTotalFare.setText(context.getResources().getString(R.string.rupees) + " " + NumberFormat.getIntegerInstance().format(Integer.parseInt(totalFare)));
            ...
            //*********set flight count*****************
            if (String.valueOf(mItem.get(position).getFlightSegments().get(0).getIntNumStops()).equals("null")){
